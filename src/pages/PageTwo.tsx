        ...
        <PluginPage>
            <div className={styles.headerRow}>
                <div className={styles.headerLeft}>
                    <h2>Bad Execution Plans</h2>
                    <p>Find queries with problematic plans in the selected time range and server. Click a query to open its latest sample details.</p>
                </div>
            ...
            <div className={styles.section}>
                ...
                {selectedServer && (
                    <>
                        ...
                        <div className={styles.section}>
                            <Card>
                                <Card.Heading>Bad Execution Plans</Card.Heading>
                                <Card.Description>
