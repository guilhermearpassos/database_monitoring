...
func (UnimplementedIngestionServiceServer) IngestWarnings(context.Context, *IngestWarningsRequest) (*IngestWarningsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IngestWarnings not implemented")
}
func (UnimplementedIngestionServiceServer) GetKnownWarnings(context.Context, *GetKnownWarningsRequest) (*GetKnownWarningsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetKnownWarnings not implemented")
}
